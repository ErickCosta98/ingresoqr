...
<div class="shadow-lg border-0 rounded-lg  bg-light  m-1 pt-lg-5"  >
  <h1 class="m-2">Orden asientos</h1>
        <form action="{{ route('lugaresBan') }}" method="post">
            @csrf
            {{-- <div>
                ...
                <tbody>
                  ...
                  <td id="{{$lugares[$i]->row_name.'-'.$j}}" style="background-color: #025441; color:white;">
                    <label class="cont" >{{$j}}
                      ...
                      <span class="checkmark" style="background-color: #025441;"></span> --}}
                    </label>
                </td> 
                    @else
